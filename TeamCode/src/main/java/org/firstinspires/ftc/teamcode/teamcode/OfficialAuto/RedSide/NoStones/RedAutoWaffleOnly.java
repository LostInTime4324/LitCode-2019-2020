...
//        }
        ...
        telemetry.addData(">", "Don't run this unless you want a penalty");
        telemetry.update();

        //Waits for you to push the triangle play button, everything before this happens after init is pushed
        waitForStart();

        encoderDrive(-7,-7,-7,-7,-1.0,-1.0,-1.0,-1.0);

        encoderDrive(24,-24,-24,24,1.0,-1.0,-1.0,1.0);

        daHooker.setPosition(1.0);

        encoderDrive(-22,22,22,-22,-1.0,1.0,1.0,-1.0);

        daHooker.setPosition(0);

        encoderDrive(-5,-5,-5,-5,-1.0,-1.0,-1.0,-1.0);

        encoderDrive(27,27,27,27,1.0,1.0,1.0,1.0);
