...
//@Autonomous(name="RedAutoOneStoneOnly", group="Pushbot")

public class RedAutoStoneOnly extends LinearOpMode {

    //Some lazily declared naviegation variables(Jank as heck)
    public double x = 0;
...
//        if (x < 12) {
//
//            distance = -NumberVariable.FIRST_DISTANCE_TO_WAFFLE.getNumber() + 20;
//
//        } else if (x >= 12 && x < 50) {
//
//            distance = -NumberVariable.SECOND_DISTANCE_TO_WAFFLE.getNumber() + 20;
//
//        } else if (x >= 50) {
//
//            distance = -NumberVariable.THIRD_DISTANCE_TO_WAFFLE.getNumber()+ 20;
//
//        } else {
//
//            distance = -NumberVariable.THIRD_DISTANCE_TO_WAFFLE.getNumber()+ 20;
...
//
//        encoderDrive(NumberVariable.DRIVE_TO_STONE.getNumber(), NumberVariable.DRIVE_TO_STONE.getNumber(), NumberVariable.DRIVE_TO_STONE.getNumber(), NumberVariable.DRIVE_TO_STONE.getNumber(), 0.4, 0.4, 0.4, 0.4);
//
//
//        encoderDrive(-(NumberVariable.DRIVE_TO_STONE.getNumber() -2), -(NumberVariable.DRIVE_TO_STONE.getNumber() -2), -(NumberVariable.DRIVE_TO_STONE.getNumber() -2 ), -(NumberVariable.DRIVE_TO_STONE.getNumber() -2), -1.0, -1.0, -1.0, -1.0);
//
