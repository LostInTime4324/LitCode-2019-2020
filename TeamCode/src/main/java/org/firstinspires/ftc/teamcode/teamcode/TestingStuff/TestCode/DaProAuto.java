...
//@Autonomous(name="DaProAuto", group="Pushbot")


public class DaProAuto extends LinearOpMode {
...
//        }
        ...
        telemetry.addData(">","It's a software problem");
        telemetry.update();
    ...
    void encoderDrive(double frontLeftInches, double backLeftInches, double frontRightInches, double backRightInches, double frontLeftSpeed, double backLeftSpeed, double frontRightSpeed, double backRightSpeed) {
        ...
        while (Math.abs(frontLeftDrive.getCurrentPosition()) < (Math.abs(newFrontLeftTarget) - 100) || Math.abs(frontRightDrive.getCurrentPosition()) < (Math.abs(newFrontRightTarget) - 100) || Math.abs(backLeftDrive.getCurrentPosition()) < (Math.abs(newBackLeftTarget) - 100) || Math.abs(backRightDrive.getCurrentPosition()) < (Math.abs(newBackRightTarget) - 100) ) {
    ...
    void nonProportionalEncoderDrive ( double frontLeftInches, double backLeftInches, double frontRightInches, double backRightInches, double frontLeftSpeed, double frontRightSpeed, double backLeftSpeed, double backRightSpeed){
