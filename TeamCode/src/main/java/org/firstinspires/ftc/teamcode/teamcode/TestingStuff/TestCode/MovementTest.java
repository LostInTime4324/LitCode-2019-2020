...
public class MovementTest extends LinearOpMode {
    ...
    //Where da skystone at doe?
    int orderFromFront = 0;
...
//    static final double     P_TURN_COEFF            = NumberVariable.PROPORTIONAL_DRIVE_CONSTANT.getNumber();     // Larger is more responsive, but also less stable 0.1
//    static final double     P_DRIVE_COEFF           = NumberVariable.PROPORTIONAL_TURN_CONSTANT.getNumber();     // Larger is more responsive, but also less stable 0.15
//    static final double     HEADING_THRESHOLD       = NumberVariable.HEADING_THRESHOLD.getNumber() ;
...
//
//                        }
//                        else if(recognition.getLeft() > 100 && recognition.getLeft() < 200){
//
//                            orderFromFront = 2;
//
//                        }
...
//
//                        }
//                        telemetry.addData(">", orderFromFront);
//
//                    }
//                }
//                telemetry.update();
...
//        RampedEncoderDrive(NumberVariable.RAMP_VARIABLE.getNumber(), 11,11,11,11,1.0, 1.0, 1.0, 1.0);
//
//        encoderDrive(-5,5,5,-5,-1.0,1.0,1.0,-1.0);
//
//        gyroTurn(0.5, 360);
//
//        RampedEncoderDrive(NumberVariable.RAMP_VARIABLE.getNumber(), 5,-5,-5,5,1.0,-1.0,-1.0,1.0);
//
//        RampedEncoderDrive(NumberVariable.RAMP_VARIABLE.getNumber(), -11,-11,-11,-11,-1.0, -1.0, -1.0, -1.0);
//
