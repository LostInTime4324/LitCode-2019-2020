package org.firstinspires.ftc.teamcode.teamcode.TestingStuff.TestCode.RedAuto;
...
public class OGScorpionAutoRedLeftDoubleStone extends LinearOpMode {    //Some lazily declared navigation variables(Jank as heck)
    public double x = 0;
    public double distance = 0;

    //Where on the line to park
    boolean Top = true;
...
//        }
        ...
        encoderDrive(distance-8,distance-8,distance-8,distance-8,1.0,1.0,1.0,1.0);

        gyroTurn(1.0,55);
        greenWheelLeftIntake.setPower(0.7);
        greenWheelRightIntake.setPower(0.7);
        encoderDrive(15,15,15,15,1.0,1.0,1.0,1.0);
        greenWheelLeftIntake.setPower(0);
        greenWheelRightIntake.setPower(0);
        encoderDrive(-10,-10,-10,-10,-1.0,-1.0,-1.0,-1.0);
        gyroTurn(1.0,-90);
        encoderDrive(distance+7,distance+7,distance+7,distance+7,1.0,1.0,1.0,1.0);

        greenWheelLeftIntake.setPower(-0.7);
        greenWheelRightIntake.setPower(-0.7);

        encoderDrive(-20,-20,-20,-20,-1.0,-1.0,-1.0,-1.0);
