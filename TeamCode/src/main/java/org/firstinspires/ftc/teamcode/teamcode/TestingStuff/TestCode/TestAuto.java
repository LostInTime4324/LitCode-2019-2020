...
//        gyroTurn(1.0, NumberVariable.TURN.getNumber());


        greenWheelLeftIntake.setPower(1.0);
        greenWheelRightIntake.setPower(1.0);

        encoderDrive(12,12,12,12,1,1,1,1);
        Thread.sleep(400);
        encoderDrive(-9,-9,-9,-9,-1,-1,-1,-1);
...
//        }
        ...
        encoderDrive(4,4,4,4,1.0,1.0,1.0,1.0);
...
//            }
    ...
    void encoderDrive ( double frontLeftInches, double backLeftInches, double frontRightInches, double backRightInches, double frontLeftSpeed, double frontRightSpeed, double backLeftSpeed, double backRightSpeed){
        ...
        while (Math.abs(frontLeftDrive.getCurrentPosition()) < (Math.abs(newFrontLeftTarget) - 10) || Math.abs(frontRightDrive.getCurrentPosition()) < (Math.abs(newFrontRightTarget) - 10) || Math.abs(backLeftDrive.getCurrentPosition()) < (Math.abs(newBackLeftTarget) - 10) || Math.abs(backRightDrive.getCurrentPosition()) < (Math.abs(newBackRightTarget) - 10)) {
